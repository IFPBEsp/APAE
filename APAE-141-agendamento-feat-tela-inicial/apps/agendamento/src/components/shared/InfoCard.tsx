...
export function InfoCard({ title, icon: Icon, value, subtitle, iconColor }: InfoCardProps) {
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between padding10">
        <CardTitle className="text-sm font-medium text-black sm:text-base">{title}</CardTitle>
