...
public class CadastroAnual {
    ...
    public CadastroAnual(UUID id, Boolean beneficioDePrestacaoContinuada, String historicosAlergias, String medicacoesContinuas, String historicoDoencas, Double rendaFamiliar, Pessoa pessoa) {
        this.id = id;
