...
public class Contato {
    ...
    public Contato(UUID id, String enderecoAtivo, String comprovanteResidencia, String endereco, String bairro, String cidade, String estado, String cep, String naturalidade, Pessoa pessoa) {
        this.id = id;
