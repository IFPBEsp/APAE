...
public class ContatoService {
    ...
    public ContatoService(ContatoRepository contatoRepository, ContatoMapper mapper, PessoaService pessoaService) {
    ...
    public ContatoResponse update(UUID id, ContatoRequest request) {
        ...
        contatoExistente.setEnderecoAtivo(request.getEndereco_ativo());
        contatoExistente.setComprovanteResidencia(request.getComprovante_residencia());
