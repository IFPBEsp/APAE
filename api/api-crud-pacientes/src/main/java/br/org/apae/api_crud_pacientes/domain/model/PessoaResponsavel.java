...
public class PessoaResponsavel {
    ...
    public enum TipoResponsavel {
        MAE, PAI, RESPONSAVEL_LEGAL, OUTRO
    }
    ...
    public PessoaResponsavel(UUID id, String ondeProcurar, boolean vivo, String profissao, String rg, String cpf, String emergencia, TipoResponsavel tipoResponsavel, Pessoa pessoa) {
        this.id = id;
    ...
    public PessoaResponsavel(String ondeProcurar, String cpf, TipoResponsavel tipoResponsavel, Pessoa pessoa) {
        this.ondeProcurar = ondeProcurar;
        this.cpf = cpf;
        this.tipoResponsavel = tipoResponsavel;
        this.pessoa = pessoa;
