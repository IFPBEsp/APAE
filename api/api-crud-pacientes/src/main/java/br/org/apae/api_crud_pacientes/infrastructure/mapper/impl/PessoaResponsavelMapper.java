...
@Component
public class PessoaResponsavelMapper implements GenericMapperInterface<PessoaResponsavelRequest, PessoaResponsavelResponse, PessoaResponsavelEntity, PessoaEntity, PessoaResponsavel> {
    ...
    public PessoaResponsavelEntity toEntity(PessoaResponsavelRequest request, PessoaEntity pessoa) {
        ...
        entity.setOndeProcurar(request.getOnde_Procurar());
    ...
    public PessoaResponsavel toDomain(PessoaResponsavelEntity entity) {
        ...
        if (entity.getTipoResponsavel() != null) {
            domain.setTipoResponsavel(PessoaResponsavel.TipoResponsavel.valueOf(entity.getTipoResponsavel().name()));
        }
