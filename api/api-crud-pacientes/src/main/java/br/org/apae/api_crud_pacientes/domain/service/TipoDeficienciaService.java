...
public class TipoDeficienciaService {
  ...
  public TipoDeficienciaService(
      TipoDeficienciaRepositoryJpa tipoDeficienciaRepository,
  ...
  public TipoDeficienciaResponse create(TipoDeficienciaRequest request) {
    ...
    TipoDeficienciaEntity tipoDeficiencia =
        tipoDeficienciaMapper.toEntity(request, pessoaExistente);
  ...
  public Page<TipoDeficienciaResponse> getAll(Pageable pageable, String descricao) {
    ...
    if (descricao != null) {
      return tipoDeficienciaRepository
          .findByDescricaoContainingIgnoreCase(descricao, pageable)
          .map(tipoDeficienciaMapper::toResponse);
    } else {
      return tipoDeficienciaRepository.findAll(pageable).map(tipoDeficienciaMapper::toResponse);
    }
  }
