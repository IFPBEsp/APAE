...
public class MedicalDocumentServiceImpl implements MedicalDocumentService {
    ...
    public MedicalDocumentResponseDTO getDocumentHistoryByType(String patientId, MedcialDocumentType type) {
        ...
        List<String> filteredObjectNames = getFilteredObjectNames(type, objectNames);
         ...
         if (filteredObjectNames.isEmpty()) {
            throw new DocumentNotFoundException(
                "Nenhum documento foi encontrado para o paciente " + patientId + " do tipo " + type
            );
        }
    ...
    private List<String> getFilteredObjectNames(MedcialDocumentType type, List<String> objectNames) {
