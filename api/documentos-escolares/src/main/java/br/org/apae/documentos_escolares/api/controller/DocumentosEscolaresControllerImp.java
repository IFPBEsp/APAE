...
public class DocumentosEscolaresControllerImp implements DocumentosEscolaresController {
    ...
    public ResponseEntity<DocumentoEscolarResponseDTO> listarDocumentosEscolares(UUID pacienteId, Integer ano) {
        DocumentoEscolarResponseDTO responseDTO = minioStorageService.listarDocumentosEscolares(pacienteId);
        if (ano != null) {
            responseDTO = minioStorageService.listarDocumentosEscolaresAno(pacienteId, ano);
        }
    ...
    public ResponseEntity<DocumentoEscolarResponseDTO> historicoDocumentosEscolares(UUID pacienteId) {
        DocumentoEscolarResponseDTO responseDTO = minioStorageService.historicoDocumentosEscolares(pacienteId);
    ...
    public ResponseEntity<byte[]> visualizarDocumentoEscolar(UUID pacienteId, String nomeArquivo) {
        byte[] response = minioStorageService.visualizarDocumentoEscolar(pacienteId, nomeArquivo);
    ...
    @Override
    public ResponseEntity<Void> removerDocumentoEscolar(UUID pacienteId, String nomeArquivo) {
