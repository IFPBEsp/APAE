...
set JARPATH=%APP_HOME%\lib\documentos-digitalizados-0.0.1-SNAPSHOT.jar

@rem Execute documentos-digitalizados
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DOCUMENTOS_DIGITALIZADOS_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%DOCUMENTOS_DIGITALIZADOS_EXIT_CONSOLE%" exit 1
exit /b 1
