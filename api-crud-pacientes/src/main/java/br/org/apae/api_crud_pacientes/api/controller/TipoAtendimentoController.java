...
public class TipoAtendimentoController {
    ...
    public ResponseEntity<TipoAtendimentoResponse> create(
            @RequestBody TipoAtendimentoRequest request,
            @RequestParam UUID pessoaId,
            UriComponentsBuilder uriBuilder) {

        TipoAtendimentoResponse response = tipoAtendimentoService.create(request, pessoaId);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TipoAtendimentoResponse> update(@PathVariable UUID id,
                                                           @RequestBody TipoAtendimentoRequest request) {
    ...
    public ResponseEntity<Page<TipoAtendimentoResponse>> getAll(
        ...
        Page<TipoAtendimentoResponse> tipoAtendimentos = tipoAtendimentoService.getAll(pageable, descricao);
