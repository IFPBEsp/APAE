...
public record UpdateAddressDTO(
        ...
        @Pattern(
                ...
                message = "O bairro deve conter apenas letras, números e espaços"
        )
        String neighborhood,
        ...
        @Pattern(
                regexp = "^[A-Za-zÀ-ÖØ-öø-ÿ0-9\\s'.,-]+$",
                message = "A rua deve conter apenas letras, números e espaços"
        )
        String street,
        ...
        @Pattern(
                ...
                message = "O número deve conter apenas letras, números, / ou -"
        )
        String number,

        @Size(max = 60, message = "O complemento deve ter no máximo 60 caracteres")
        @Pattern(
                regexp = "^[A-Za-zÀ-ÖØ-öø-ÿ0-9\\s'°º.,-]*$",
                message = "O complemento contém caracteres inválidos"
        )
        String complement) {
}
