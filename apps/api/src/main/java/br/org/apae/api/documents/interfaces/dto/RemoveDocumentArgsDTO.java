...
public record RemoveDocumentArgsDTO(UUID id,
        String name,
    ...
    public static RemoveDocumentArgsDTO.Builder builder() {
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        public RemoveDocumentArgsDTO build() {
            ...
            return new RemoveDocumentArgsDTO(id, name, category, type, owner, year);
        }
    }
}
