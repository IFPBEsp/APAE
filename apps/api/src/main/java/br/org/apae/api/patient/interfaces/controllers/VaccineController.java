...
public interface VaccineController {
    ...
    @Operation(
            ...
            description = "Retorna os dados de uma vacina específica pelo seu ID."
    )
    @ApiResponses(value = {
    ...
    @PostMapping
    ResponseEntity<VaccineResponseDTO> create(
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Dados inválidos"),
            @ApiResponse(responseCode = "404", description = "Vacina não encontrada"),
            @ApiResponse(responseCode = "409", description = "Já existe outra vacina com esse nome")
    })
    @PutMapping("/{id}")
    ResponseEntity<VaccineResponseDTO> update(
            @PathVariable UUID id,
    ...
    @Operation(
            ...
            description = "Exclui uma vacina que não esteja vinculada a pacientes."
    )
    @ApiResponses(value = {
