...
public class GeneratedAppointment {
    ...
    @Formula("(SELECT ca.paciente_id FROM cadastro_anual ca JOIN agendamento a ON a.cadastro_anual_id = ca.id WHERE a.id = agendamento_id)")
    private UUID getPatientId() { return patientId; }
    ...
    public void setOverriddenDateTime(LocalDateTime overriddenDateTime) { this.overriddenDateTime = overriddenDateTime; }
