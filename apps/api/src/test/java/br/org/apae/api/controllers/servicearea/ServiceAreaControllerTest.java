...
class ServiceAreaControllerTest {
    ...
    @Test
    void shouldReturnForbiddenWhenCreatingWithoutToken() throws Exception {
        CreateServiceAreaDTO request = new CreateServiceAreaDTO("SAÚDE");
    ...
    @Test
    void shouldReturnForbiddenWhenListingWithoutToken() throws Exception {
        mockMvc.perform(get(URI))
                .andExpect(status().isForbidden());
    }

    @Test
    void shouldReturnForbiddenWhenFindingByIdWithoutToken() throws Exception {
        mockMvc.perform(get(URI_WITH_ID, 1))
                .andExpect(status().isForbidden());
    }
    ...
    @Test
    void shouldReturnForbiddenWhenDeletingWithoutToken() throws Exception {
        mockMvc.perform(delete(URI_WITH_ID, 1))
                .andExpect(status().isForbidden());
    }
}