...
export default async function VisualizarAgendamento({ params }: PageProps) {
  ...
  const agendamento = {
    ...
    agendamentoMarcado: {
      ...
      justificativa:
        "Justificativa do agendamento. Esta seção pode conter informações sobre o motivo pelo qual o agendamento foi marcado, como sintomas, preocupações de saúde ou outras razões que levaram à necessidade de consulta.",
    },
    profissionalDaSaude: {
      nome: "asasdfa",
  ...
  const statusInfo = getStatusStyle(
    ...
    agendamento.agendamentoMarcado.dataHora
  );
    ...
    <div className={"mt-20 w-full mr-17 ml-10"}>
      <header className={"flex flex-row items-center justify-between"}>
        <div className={"flex items-center"}>
          ...
          <h1
            className={
              "ml-10 text-[#0D4F97] text-xl md:text-2xl font-bold mr-5"
            }
          >
            {agendamento.nome}
          </h1>
        ...
        <Card className={"text-[#0D4F97]  mb-7"}>
          ...
          <CardContent>
            ...
            <div className={"flex mb-2"}>
              ...
              <p>
                {agendamento.agendamentoMarcado.dataHora.toLocaleString(
                  "pt-BR",
            ...
            <div className={"mb-2"}>
              ...
              <p className={"break-words whitespace-pre-wrap"}>
                {agendamento.agendamentoMarcado.descricao}
              </p>
            </div>
            <div className={"mb-3"}>
              <p className={"font-medium mb-1"}>Justificativa: </p>
              <p className={"break-words whitespace-pre-wrap"}>
                {agendamento.agendamentoMarcado.justificativa}
              </p>
            </div>
          </CardContent>
        </Card>
