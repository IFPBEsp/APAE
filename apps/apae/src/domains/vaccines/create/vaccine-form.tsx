...
import { createVaccineSchema, type CreateVaccineFormData } from "@/domains/vaccines/vaccines.schema";
    ...
    <div className="!bg-slate-100 min-h-screen">
      <main className="container mx-auto p-4 md:p-6">
        <div className="bg-white rounded-xl shadow-md border-2 p-6 mb-4">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(createVaccine)} className="space-y-4">
              <FormField
