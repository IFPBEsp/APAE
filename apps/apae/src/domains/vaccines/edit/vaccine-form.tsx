...
} from "@/domains/vaccines/vaccines.schema";
...
export function VaccineEditForm({ id }: VaccineEditFormProps) {
  ...
  const { vaccine, updateVaccine, isLoading, isSubmitting } = useVaccineEdit(id);
  ...
  if (isLoading || !vaccine) {
    return (
      <div className="flex justify-center items-center p-10 min-h-screen !bg-slate-100">
