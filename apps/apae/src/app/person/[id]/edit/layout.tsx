          ...
          personal: {
            ...
            rg: {
              ...
              issuing: {
                ...
                date: parseCivilDate(data.issueDate) || new Date(),
              },
            },
            cns: data.cns || "",
            nis: data.nis || "",
            birth: {
              ...
              date: parseCivilDate(data.birthDate) || new Date(),
...
function MobileStepIndicator() {
  ...
  const stepsList = [
    {
      id: MembersRegisterStep.PERSONAL,
      label: "Dados Pessoais",
      shortLabel: "Pessoal",
    },
    {
      id: MembersRegisterStep.KINSHIPS,
      label: "Parentesco",
      shortLabel: "Parentes",
    },
    {
      id: MembersRegisterStep.ADDRESS,
      label: "Endereço",
      shortLabel: "Endereço",
    },
    {
      id: MembersRegisterStep.ADDITIONALS,
      label: "Saúde & Social",
      shortLabel: "Saúde",
    },
    {
      id: MembersRegisterStep.GUARDIAN,
      label: "Responsável",
      shortLabel: "Resp.",
    },
    {
      id: MembersRegisterStep.PROFILE,
      label: "Perfil & Documentos",
      shortLabel: "Perfil",
    },
  ];
        ...
        {stepsList.map((s, index) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`text-[10px] whitespace-nowrap ${isCurrent ? "text-white font-semibold" : "text-blue-200"}`}
              >
                {s.shortLabel}
              </span>
            </div>
