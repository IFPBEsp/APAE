...
const mockReports = [
  {
    id: "1",
    title: "Relatório Comportamental Semestral",
    date: "15/05/2026",
    author: "Psicóloga Ana",
    status: "Concluído",
  },
  {
    id: "2",
    title: "Acompanhamento Fonoaudiológico",
    date: "10/06/2026",
    author: "Fono. Carlos",
    status: "Em andamento",
  },
...
const mockReviews = [
  {
    id: "1",
    discipline: "Desenvolvimento Cognitivo",
    date: "20/05/2026",
    grade: "B",
    observation: "Apresentou boa evolução.",
  },
  {
    id: "2",
    discipline: "Linguagem e Comunicação",
    date: "12/06/2026",
    grade: "A",
    observation: "Excelente progresso na fala.",
  },
];
  ...
  return (
    <main className="container mx-auto p-4 md:p-6 font-nunito space-y-6">
      <div className="flex flex-col gap-4">
        ...
        <div>
          <h2 className="font-baloo font-bold text-[#0D4F97] text-[28px]">
            Relatórios e Avaliações Escolares
          </h2>
          <p className="text-gray-500">
            Acompanhamento do desenvolvimento educacional do paciente.
          </p>
        </div>
      </div>
                        ...
                        filteredReports.map((reports) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 text-center">
                              <span
                                className={`px-3 py-1 rounded-full text-xs font-semibold ${reports.status === "Concluído" ? "bg-green-100 text-green-700" : "bg-amber-100 text-amber-700"}`}
                              >
                                {reports.status}
                              </span>
                            </td>
                    ...
                    <tbody>
                      {reviews.map((av) => (
                        <tr key={av.id} className="border-b hover:bg-slate-50 transition-colors">
                          ...
                          <td className="px-6 py-4 font-bold text-[#0D4F97] text-center">
                            {av.grade}
                          </td>
