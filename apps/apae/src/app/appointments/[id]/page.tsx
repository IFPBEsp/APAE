...
import { getAppointmentById, Appointment } from "@/app/services/appointmentService";
  ...
  return (
    <div className="mt-20 flex-1 mr-17 ml-10">
      <header className="flex flex-row items-center justify-between">
        ...
        >
          <p className="text-sm font-bold">{appointment.isActive ? "Ativa" : "Não ativa"}</p>
        </Badge>
      </header>
            ...
            <CardAction className="flex gap-1">
              ...
              <div className="rounded-full overflow-hidden border-1 border-[#0D4F97]">
                <TrashButton
                  id={id}
                  realized={false}
                  hasHistory={!!(appointment.replacedByDate || appointment.updatedFromDate)}
                />
              </div>
            </CardAction>
          </CardHeader>
            ...
            <div className="flex justify-between">
              <div className="flex flex-col gap-1">
                ...
                <div className="flex">
                  ...
                  <p
                    className={`font-bold ${appointment.isActive ? "text-green-700" : "text-red-700"}`}
                  >
