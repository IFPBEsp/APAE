...
function SheetHeader(props: Readonly<React.ComponentProps<"div">>) {
...
function SheetFooter(props: Readonly<React.ComponentProps<"div">>) {
  const { className, ...rest } = props
  return (
    <div
...
function SheetTitle(props: Readonly<React.ComponentProps<typeof SheetPrimitive.Title>>) {
  const { className, ...rest } = props
  return (
...
function SheetDescription(props: Readonly<React.ComponentProps<typeof SheetPrimitive.Description>>) {
  const { className, ...rest } = props
  return (
